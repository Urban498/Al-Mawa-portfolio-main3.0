...
const SidebarContent = ({ activeSection, setActiveSection, onLogout }: AdminSidebarProps) => {
  ...
  const menuItems: MenuItem[] = [
    ...
    { label: "Internship Applications", key: "internship", icon: <IconSettings size={20} /> },
    { label: "Franchise Applications", key: "franchise", link: "/admin/franchise-applications", icon: <IconBriefcase size={20} /> },
    { label: "Referral Applications", key: "referral", link: "/admin/referral-applications", icon: <IconUsers size={20} /> },
    { label: "Courses", key: "courses", link: "/admin/courses", icon: <IconSettings size={20} /> },
