...
// ✅ Shimmer Text Component with continuous animation
    ...
    <>
      <style>{`
        ...
        .shimmer-text-effect {
          ...
          animation: floatingShimmer ${speedMap[speed]} linear infinite; /* ✅ continuous shimmer */
        }
      `}</style>
      <span className={`shimmer-text-effect ${className}`}>{text}</span>
    </>
  );
};
    ...
    <div className={cn("mt-16 sm:mt-20 md:mt-28 lg:mt-24", className)}>
      ...
      <div className="flex justify-center items-center w-full mb-16 sm:mb-12 md:-mb-2 lg:-mb-0 -mt-16">
        <svg
          ...
          className="-mt-12 sm:-mt-40 md:-mt-60 lg:-mt-95 w-full max-w-[1440px] h-auto max-h-[200px] sm:max-h-[300px] md:max-h-[400px] lg:max-h-none"
        >
          <motion.path
