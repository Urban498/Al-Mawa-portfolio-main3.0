...
export default function FranchiseFormModal({ isOpen, onClose }: FranchiseFormModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const res = await axios.post("/api/franchise-apply", data);
