...
const socialMediaWork = [
  ...
  {
    url: "https://www.instagram.com/lifestylehomedecorpune/",
        ...
        >
          ...
          <div className="relative aspect-video bg-gradient-to-br from-gray-100 to-gray-50 overflow-hidden">
            ...
            <div className="absolute inset-0 opacity-20">
              ...
              <div className="absolute bottom-0 right-0 w-72 h-72 bg-cyan-400 rounded-full mix-blend-multiply filter blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
            </div>
            ...
            <div className="absolute inset-0 flex items-center justify-center z-10">
              <div className={`relative transition-all duration-500 ${isHovered ? 'scale-110' : 'scale-100'}`}>
                ...
                <div className="relative w-20 h-20 rounded-full bg-white backdrop-blur-sm flex items-center justify-center shadow-xl border-2 border-gray-100 group-hover:bg-blue-500 group-hover:border-blue-500 transition-all duration-300">
                  <Play className="w-8 h-8 text-gray-900 ml-1 group-hover:text-white transition-colors duration-300" fill="currentColor" />
                </div>
              </div>
            </div>
      ...
      <LinkPreview url={site.url} className="block h-full">
        ...
        >
          ...
          <div className="relative aspect-video bg-gradient-to-br from-gray-100 to-gray-50 overflow-hidden">
            {/* Gradient mesh background */}
            <div className="absolute inset-0 opacity-20">
              <div className="absolute top-0 left-0 w-64 h-64 bg-blue-400 rounded-full mix-blend-multiply filter blur-3xl animate-pulse" />
              <div className="absolute bottom-0 right-0 w-64 h-64 bg-cyan-400 rounded-full mix-blend-multiply filter blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
            </div>
            ...
            <div className="absolute inset-0 flex items-center justify-center z-10">
              <div className={`relative transition-all duration-500 ${isHovered ? 'scale-110' : 'scale-100'}`}>
                ...
                <div className="relative p-6 rounded-2xl bg-white/90 backdrop-blur-xl border border-gray-200 group-hover:border-blue-400 transition-all duration-300">
          ...
          <div className="relative p-5 bg-white border-t border-gray-100 flex-1 flex flex-col justify-between">
            ...
            <div className="flex items-center gap-2 mt-4">
              <div className="px-2 py-0.5 rounded-full bg-blue-50 border border-blue-200">
                <span className="text-[10px] text-blue-600 uppercase tracking-wider font-medium">Next.js</span>
              </div>
              <div className="px-2 py-0.5 rounded-full bg-blue-50 border border-blue-200">
                <span className="text-[10px] text-blue-600 uppercase tracking-wider font-medium">Tailwind</span>
              </div>
            </div>
        ...
        <section className="relative max-w-6xl mx-auto px-4 pt-20 pb-14 md:pt-24 lg:pt-28 lg:pb-16">
          ...
          >
            ...
            <h1 className="text-3xl md:text-5xl lg:text-6xl font-semibold tracking-tight">
              What Our 
                <span className="font-[family-name:var(--font-corpta)] font-light text-7xl text-[#0ea5e9]"> Clients </span>
              Say
            </h1>
            <p className="text-sm md:text-base text-muted-foreground leading-relaxed max-w-2xl">
              A selection of brands that trust{" "}
              <span className="text-[#0ea5e9] font-bold">AL-MAWA International</span> to
        ...
        <section className="relative max-w-6xl mx-auto px-4 py-12 md:py-16 lg:py-18">
          ...
          >
            <div className="space-y-3">
              ...
              <p className="text-sm md:text-base text-muted-foreground max-w-xl">
               Engaging social media content designed to represent your brand with clarity and impact.
              </p>
            </div>
          </motion.div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-7">
            {socialMediaWork.map((item, index) => (
              <SocialMediaCard key={item.title + index} item={item} index={index} />
            ))}
          </div>
        </section>
        ...
        <section className="relative max-w-6xl mx-auto px-4 pb-16 md:pb-20 lg:pb-24">
          ...
          >
            <div className="space-y-3">
              ...
              <p className="text-sm md:text-base text-muted-foreground max-w-xl">
                Explore our portfolio of custom website solutions built for businesses of all sizes.
              </p>
            </div>
          </motion.div>
