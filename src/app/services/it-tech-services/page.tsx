...
const services = [
  {
    ...
    description: "Comprehensive overview of all our IT and technology service offerings",
    features: ["Service Portfolio", "Technology Stack", "Implementation Process", "Support Structure"]
  },
  {
    icon: Server,
    title: "Infrastructure Services",
    description: "Robust IT infrastructure solutions for scalable and reliable business operations",
    features: ["Network Setup", "Server Management", "Hardware Installation", "System Architecture"]
  },
  {
    icon: Settings,
    title: "Managed IT Services",
    description: "Complete IT management and monitoring to keep your systems running smoothly",
    features: ["24/7 Monitoring", "Proactive Maintenance", "System Updates", "Performance Optimization"]
  },
  {
    icon: Shield,
  ...
  },
  {
    ...
    description: "Modern cloud solutions and DevOps practices for efficient development and deployment",
    features: ["Cloud Migration", "DevOps Implementation", "CI/CD Pipelines", "Container Management"]
  },
  {
    icon: Code,
    title: "Software Development Services",
    description: "Custom software solutions tailored to your specific business requirements",
    features: ["Custom Applications", "System Integration", "API Development", "Legacy Modernization"]
  },
  {
    icon: Users,
    title: "IT Consulting & Advisory",
    description: "Strategic IT guidance to align technology with your business objectives",
    features: ["Technology Strategy", "Digital Transformation", "IT Planning", "Risk Assessment"]
  },
  {
    icon: BarChart3,
    title: "Data & Analytics Services",
    description: "Transform your data into actionable insights for better business decisions",
    features: ["Data Analysis", "Business Intelligence", "Reporting Solutions", "Data Visualization"]
  },
  {
    icon: MessageSquare,
    title: "Communication & Collaboration Services",
    description: "Modern communication tools and collaboration platforms for remote teams",
    features: ["Video Conferencing", "Team Collaboration", "Document Sharing", "Remote Access"]
  },
  {
    icon: HeadphonesIcon,
    title: "IT Support & Helpdesk Services",
    description: "Comprehensive technical support and helpdesk services for your IT needs",
    features: ["Technical Support", "Issue Resolution", "User Training", "Documentation"]
  },
  {
    icon: Zap,
    title: "Emerging Technology Services",
    description: "Cutting-edge technology solutions including AI, IoT, and blockchain implementations",
    features: ["AI Integration", "IoT Solutions", "Blockchain Development", "Automation Tools"]
  },
  {
    icon: CheckCircle,
    title: "Benefits of IT & Tech Services",
    description: "Key advantages and benefits of implementing our IT and technology services",
    features: ["Cost Reduction", "Enhanced Security", "Improved Productivity", "Strategic Growth"]
  }
];
      ...
      >
        <div className="max-w-7xl mx-auto text-center">
          ...
          <motion.p
            ...
            variants={fadeInUp}
          >
            Comprehensive IT solutions and technology services to power your business forward. 
            From infrastructure to emerging technologies, we&apos;ve got you covered.
          </motion.p>
        </div>
      </motion.section>
