...
const services = [
  {
    ...
    description: "Advanced machine learning solutions to automate processes and extract insights from your data",
  ...
  },
  {
    ...
    description: "Intelligent text processing and language understanding capabilities for your applications",
    features: ["Text Analysis", "Chatbots & Virtual Assistants", "Sentiment Analysis", "Language Translation"]
  },
  {
    icon: Eye,
    title: "Computer Vision Services",
    description: "Advanced image and video analysis capabilities to automate visual tasks and extract insights",
    features: ["Object Detection", "Image Classification", "Facial Recognition", "Quality Inspection"]
  },
  {
    icon: Cpu,
    title: "Generative AI Services",
    description: "Cutting-edge generative AI solutions to create content, code, and innovative applications",
    features: ["Content Generation", "Code Automation", "Creative Design", "Synthetic Data"]
  },
  {
    icon: Zap,
    title: "AI Automation Services",
    description: "Intelligent automation solutions to streamline workflows and increase operational efficiency",
    features: ["Process Automation", "Intelligent Document Processing", "Workflow Optimization", "RPA Integration"]
  },
  {
    icon: BarChart3,
    title: "Data & Analytics AI Services",
    description: "AI-powered analytics and insights to drive data-driven decision making across your organization",
    features: ["Predictive Analytics", "Business Intelligence", "Data Visualization", "Real-time Insights"]
  },
  {
    icon: Shield,
    title: "AI in Cybersecurity",
    description: "Advanced AI-driven security solutions to protect your digital assets and detect threats",
    features: ["Threat Detection", "Behavioral Analysis", "Security Automation", "Risk Assessment"]
  },
  {
    icon: Building,
    title: "Industry-Specific AI Solutions",
    description: "Tailored AI solutions designed for specific industries and business verticals",
    features: ["Healthcare AI", "Financial Services", "Manufacturing", "Retail & E-commerce"]
  },
  {
    icon: Server,
    title: "AI Infrastructure & MLOps",
    description: "Robust AI infrastructure and MLOps practices to deploy and manage AI models at scale",
    features: ["Model Deployment", "Pipeline Automation", "Monitoring & Maintenance", "Scalable Infrastructure"]
  },
  {
    icon: GraduationCap,
    title: "AI Training & Support",
    description: "Comprehensive training and ongoing support to help your team leverage AI technologies effectively",
      ...
      >
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            ...
            Our comprehensive AI services help you leverage cutting-edge technology for competitive advantage.
          </motion.p>
        </div>
      </motion.section>
        ...
        <div className="max-w-7xl mx-auto">
          <motion.div className="text-center mb-12" variants={fadeInUp}>
            ...
            <p className={`text-lg text-gray-600 max-w-2xl mx-auto ${playfair_display.className}`}>
              Transform your business with intelligent solutions designed for the future
            </p>
          </motion.div>
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className={`text-lg text-gray-600 mb-8 ${playfair_display.className}`}>
            ...
            Start your AI transformation today and unlock new possibilities for your business.
          </p>
